...
if __name__ == '__main__':
    ...
    stack = Stack(4)
    # Add your code in front of the comments that it corresponds to. 


    # Inserting Black Pepper 1 on shelf
    # Inserting Black Pepper 2 on shelf
    # Inserting Black Pepper 3 on shelf
 
    # removing the top element black pepper 3
    # removing the top element black pepepr 2
    # removing the top element black pepper 1
 
    # Inserting black pepper 4 on shelf

    print('The black pepper that is in front is ', stack.peek())
    print('The amount of black pepper on the shelf is ', stack.size())
 
    # removing the top element black pepper 4
